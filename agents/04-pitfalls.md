...
- **修复**：改成直述场景（「带货号的那句」「日常说法、库里未必同词的那句」）；业界没有的词不准当术语、不准硬配英文括注。对照根 [AGENTS.md 白话强制](../AGENTS.md) + [06-teach §6.2 2a](agents/06-teach.md) + [05-demo §5.3.11.a](agents/05-demo.md#5311a-用户可见文案格式--中文为主--英文括注2026-09-09-立--强制)
