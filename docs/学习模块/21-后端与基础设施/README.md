[目录](../../00-目录.md) · [学习模块](../README.md) · [学习总览](../../06-学习总览.md) · 代码地图见本模块「模块复盘」MD / `apps/21-后端与基础设施/{小节文件夹}/README.md`

# 模块 21 · 后端 & 基础设施 ⭐⭐⭐⭐

[← 20 AI Security](../20-AI-Security/README.md) · [22 AI 全栈产品化 →](../22-AI全栈产品化/README.md)

> **小节进度、验收、动手落点**在本 README；**每条学习沉淀**在同目录单独 MD（「重点」列已链接）。有代码时，「现在怎么跑」以 `apps/21-后端与基础设施/{小节文件夹}/README.md` 为准。
> **代码落点**：`apps/21-后端与基础设施/{小节文件夹}/`（每条外部小节的最小可运行 Demo；详见 [AGENTS.md §4](../../../AGENTS.md#4-代码落点)）
...
> 落到 `apps/21-后端与基础设施/{小节文件夹}/`。必须真部署一次。
