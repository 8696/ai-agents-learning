[目录](../../00-目录.md) · [学习模块](../README.md) · [学习总览](../../06-学习总览.md) · 代码地图见本模块「本地产出」MD / `apps/22-AI全栈产品化/01-{短名}/` README

# 模块 22 · AI 全栈产品化 ⭐⭐⭐⭐⭐

[← 21 后端 & 基础设施](../21-后端与基础设施/README.md) · [23 Production Agent Architecture →](../23-Production-Agent-Architecture/README.md)

> **小节进度、验收、本地拆步**在本 README；**每条学习沉淀**在同目录单独 MD（「重点」列已链接）。有代码时，「现在怎么跑」以 `apps/22-AI全栈产品化/01-{短名}/README.md` 为准。
> **代码落点**：`apps/22-AI全栈产品化/01-{短名}/`（每条外部小节的最小可运行 UI Demo）。模块 00 mini-app 的最简流式 UI 在 `apps/00-环境准备/01-mini-app/`。
