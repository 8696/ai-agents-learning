...
| ✅ | [**Token Budget**：给历史、给系统、给本轮各留多少](./03-Token-Budget.md) | 能设阈值，知道何时触发裁剪 | `token budget chatbot` `context window management` · tiktoken + 自己打印 full context | [沉淀](./03-Token-Budget.md) |
