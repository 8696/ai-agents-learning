...
`50072`（已与 `apps/package.json` 的 `PORT=50072` inline + `lib/http/runtime-ctx.ts` 的 `.default(50072)` + `public/components/layout.js` 的页脚 fallback + `apps/README.md` 占用表 四处一致）。
