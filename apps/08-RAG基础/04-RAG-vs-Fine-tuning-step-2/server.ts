...
import { mountRagEmptyRoute } from "./routes/rag-empty.js";
import { mountRagFewshotRoute } from "./routes/rag-fewshot.js";
...
mountRagEmptyRoute(router);
mountRagFewshotRoute(router);
...
app.listen(PORT, "127.0.0.1", () => {
  ...
  logger.info(
    "server.start",
    "listening",
    "服务起好了；step-2 教学要点：同一问句、同一份检索材料，左栏空系统提示词 vs 右栏带 3 条品牌范例 —— 看口吻差异。本步没有训练任务。",
    {
