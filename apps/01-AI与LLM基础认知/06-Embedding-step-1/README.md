...
cd apps
yarn install
yarn app:01-06-embedding-step-1
```

端口 `50003` · 浏览器 `http://127.0.0.1:50003/`
...
[docs/学习模块/01-AI与LLM基础认知/06-Embedding-step-1.md](../../../docs/学习模块/01-AI与LLM基础认知/06-Embedding-step-1.md)
