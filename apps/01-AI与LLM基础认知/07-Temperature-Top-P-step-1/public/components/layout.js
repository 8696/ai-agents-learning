...
(function () {
  ...
  var NAV_ITEMS = [
    ...
    { href: "/pages/temperature.html", label: "温度对照", match: "temperature" },
    { href: "/pages/top-p.html", label: "Top-P 对照", match: "top-p" },
    { href: "/pages/repeat.html", label: "重复稳定性", match: "repeat" },
  ];

  function currentKey() {
    var p = window.location.pathname;
    if (p === "/" || p.endsWith("/index.html")) return "index";
    if (p.endsWith("/temperature.html")) return "temperature";
    if (p.endsWith("/top-p.html")) return "top-p";
    if (p.endsWith("/repeat.html")) return "repeat";
    return "";
  }
