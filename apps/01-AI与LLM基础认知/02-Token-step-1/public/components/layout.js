...
(function () {
  ...
  var NAV_ITEMS = [
    ...
    { href: "/pages/compare.html", label: "中英对照", match: "compare" },
    { href: "/pages/encode.html", label: "自定义文本", match: "encode" },
  ];
  ...
  function currentKey() {
    ...
    if (p.endsWith("/encode.html")) return "encode";
    return "";
  }
  ...
  function EnvFooter({ env }) {
    return (
      <footer id="page-footer" className="border-t p-2 text-xs text-gray-500 text-center">
        <span id="env-info">
          端口 {env.port || 50002} · 本地计算（不调 LLM）· provider{" "}
