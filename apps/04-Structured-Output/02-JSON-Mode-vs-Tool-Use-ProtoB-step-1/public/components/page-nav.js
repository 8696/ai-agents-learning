...
(function () {
  ...
  {
    "key": "overview",
    "label": "总览 · JSON Mode vs Tool-Use",
    "href": "index.html"
  },
  {
    "key": "text",
    "label": "无 tools（类 JSON Mode）",
    "href": "pages/text.html"
  },
  {
    "key": "tool-rejected",
    "label": "诱导守约 · 协议 B",
    "href": "pages/tool-rejected.html"
  },
  {
    "key": "tool-use",
    "label": "tool-use（类 Structured Output）",
    "href": "pages/tool-use.html"
  }
];
