...
const STORE: Todo[] = [
  ...
  { id: "todo-005", title: "下单防晒霜（旅游前）",        tag: "购物", dueDate: daysFromToday(-5), done: false },
  { id: "todo-006", title: "退掉重复买的书",              tag: "购物", dueDate: daysFromToday(0),  done: false },
  { id: "todo-007", title: "提交季度汇报",                tag: "工作", dueDate: daysFromToday(0),  done: false },
  { id: "todo-008", title: "回 HR 邮件",                 tag: "工作", dueDate: daysFromToday(-2), done: false },
  { id: "todo-009", title: "跑步 5 公里",                tag: "健身", dueDate: daysFromToday(-4), done: false },
  { id: "todo-010", title: "瑜伽课",                     tag: "健身", dueDate: daysFromToday(1),  done: false },
  { id: "todo-011", title: "买猫零食（提前）",            tag: "购物", dueDate: daysFromToday(-7), done: false },
  { id: "todo-012", title: "换季衣物收纳",                tag: "购物", dueDate: daysFromToday(3),  done: false },
];
...
/**
 * 返回当前内存里所有 todo 的**深拷贝**快照（防止前端拿到内部引用后被后续修改污染）。
 * step-1 不持久化（§5.3.17 是后续模块的事）；内存里的这份就是「事实」。
 */
