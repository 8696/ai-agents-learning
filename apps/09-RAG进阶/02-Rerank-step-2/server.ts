...
import { mountRerankBusiness } from "./routes/rerank-business.js";
...
app.listen(PORT, "127.0.0.1", () => {
  logger.info(
    "server.start",
    "listening",
    "Rerank step-2：粗召回（向量+BM25+RRF）→ 神经精排（真调大模型按问句+文档打分）→ 业务加权（按 updatedAt 加权 · 纯本地）",
    {
