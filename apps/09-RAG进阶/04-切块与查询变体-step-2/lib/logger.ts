/**
 * 职责：本 Demo 的服务端日志（本地 freeze 副本 · 拷自顶层 2026-09-14）。
 * 数据流：createLogger(logDir) → mkdir → logger.info(scope, msg, explain, data?) → logs/{日期}.log
 * 禁止运行时 import 顶层 apps/logger.ts。
 *
