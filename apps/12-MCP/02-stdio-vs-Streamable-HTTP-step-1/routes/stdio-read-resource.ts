/**
 * 职责：POST /api/stdio/read-resource —— 触发 MCP 协议 resources/read。
...
export function mountStdioReadResource(router: Router): void {
  router.post("/api/stdio/read-resource", async (ctx: Context) => {
