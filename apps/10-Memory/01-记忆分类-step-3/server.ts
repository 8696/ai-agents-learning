...
import { mountRetrieveRoutes } from "./routes/retrieve.js";
import { mountAskRoutes } from "./routes/ask.js";
...
mountRetrieveRoutes(router);
mountAskRoutes(router);
...
app.listen(PORT, "127.0.0.1", () => {
  logger.info("server.start", "listening", "记忆分类第三步：检索 / 按相关性召回 + 拼进 Prompt + 调大模型。", {
