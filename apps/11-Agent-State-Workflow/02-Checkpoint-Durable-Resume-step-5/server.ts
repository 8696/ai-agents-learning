...
import { mountRunBrewFailRoutes } from "./routes/run-brew-fail.js";
...
app.listen(PORT, "127.0.0.1", () => {
  logger.info(
    "server.start",
    "listening",
    "服务起好了；step-5 二页一口：总览 + 节点失败 ≠ 进程被杀掉。step-1 / step-2 / step-3 / step-4 那几页（端口 50121 / 50122 / 50123 / 50124）不在这里复刻。",
