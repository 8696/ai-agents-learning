...
window.DemoUtils.writeHalf = function (runId) {
  return fetchJson("/api/run/write-half", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({ runId: runId }),
  });
};
window.DemoUtils.setGraphVersion = function (version) {
  return fetchJson("/api/run/set-graph-version", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({ version: version }),
  });
};
window.DemoUtils.getHealth = function () {
