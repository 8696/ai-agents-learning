...
import { mountRunSetGraphVersionRoutes } from "./routes/run-set-graph-version.js";
...
mountRunSetGraphVersionRoutes(router);
...
app.listen(PORT, "127.0.0.1", () => {
  logger.info(
    "server.start",
    "listening",
    "服务起好了；step-4 三页一口：总览 + 图版本失败可见。step-1 / step-2 / step-3 那几页（端口 50121 / 50122 / 50123）不在这里复刻。",
