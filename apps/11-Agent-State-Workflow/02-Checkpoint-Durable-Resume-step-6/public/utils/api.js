...
window.DemoUtils.shippingRefundStart = function (orderId) {
  return fetchJson("/api/run/shipping-refund/start", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({ orderId: orderId }),
  });
};
window.DemoUtils.shippingRefundStep = function (runId) {
  return fetchJson("/api/run/shipping-refund/step", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({ runId: runId }),
  });
