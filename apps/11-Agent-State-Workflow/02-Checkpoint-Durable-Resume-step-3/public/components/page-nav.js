...
(function () {
  ...
  const PAGES = [
    { key: "overview", label: "总览 · step-3", href: "index.html" },
    { key: "pure-vs-sideeffect", label: "纯计算 vs 扣款", href: "pages/pure-vs-sideeffect.html" },
    { key: "half-written", label: "半份文件退回", href: "pages/half-written.html" },
  ];
