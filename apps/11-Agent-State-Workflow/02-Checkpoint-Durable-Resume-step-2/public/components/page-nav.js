...
(function () {
  ...
  const PAGES = [
    { key: "overview", label: "总览 · step-2", href: "index.html" },
    { key: "next-run", label: "终态开新业务", href: "pages/next-run.html" },
    { key: "memory-vs-disk", label: "内存 vs 磁盘", href: "pages/memory-vs-disk.html" },
  ];
