 ...
 *   前端在 /api/chat 返回值里拿到完整 request/response + tool_results，把"协议 B 跟 A 长什么样不一样"在页面**自动可见**。
 *
...
//   content 是 blocks 数组（可同时含 text / tool_use / tool_result / image 等）
...
export type AnthropicContentBlock =
  ...
  | { type: "tool_use"; id: string; name: string; input: Record<string, unknown> }  // input 是对象
