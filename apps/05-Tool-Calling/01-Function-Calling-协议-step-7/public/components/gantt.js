 ...
 *
 * 教学锚点（§5.3.10/11）：把「并行调用」这一步变成**可观察行为**——
...
(function () {
  ...
  // step-7 配色：get_weather=blue / suggest_items=green；与 step-3（紫/橙）区分
  var TOOL_PALETTE = {
    get_weather: "bg-blue-400",
    suggest_items: "bg-green-400",
    // 路由层拒绝的伪 tool_call 也画条，方便看拒绝位置
    router_reject: "bg-red-300",
  };
