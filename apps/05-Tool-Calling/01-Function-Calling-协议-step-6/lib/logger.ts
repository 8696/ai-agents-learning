/**
 * 职责：本地日志服务 freeze 副本（lock-time freeze 于 2026-09-05）。
 ...
 * 文件：apps/05-Tool-Calling/01-Function-Calling-协议-step-8-protocol-data-shape/logs/{YYYY-MM-DD}.log（按 BJT 日切，无 serviceName 前缀）
