...
对应：[模块 02 · LLM API 开发](../../../docs/学习模块/02-LLM-API开发/02-协议-A-vs-B-step-1.md)
...
`app:02-02-protocol-ab-step-1` → `tsx 02-LLM-API开发/02-协议-A-vs-B-step-1/server.ts`

## 概念

[docs/学习模块/02-LLM-API开发/02-协议-A-vs-B-step-1.md](../../../docs/学习模块/02-LLM-API开发/02-协议-A-vs-B-step-1.md)
